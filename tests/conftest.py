...
from mbrowser.adapters import memory_repository, database_repository
...
TEST_DATA_PATH_MEMORY = os.path.join('C:\\Users\\PC\\Desktop\\git-files\\movie-browser\\tests\\data\\memory')
TEST_DATA_PATH_DATABASE = os.path.join('C:\\Users\\PC\\Desktop\\git-files\\movie-browser\\tests\\data\\database')
# TEST_DATA_PATH = os.path.join('C:\\Users\\justi\\Desktop\\git-projects\\movie-browser\\tests\\data')

TEST_DATABASE_URI_IN_MEMORY = 'sqlite://'
TEST_DATABASE_URI_FILE = 'sqlite:///mbrowser-test.db'
